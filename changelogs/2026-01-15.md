...
[parallel] ✅ COMPLETED task_a1b2 → builder: Implement feature X (2m 30s)
...
|-------|------------|
| Spawn | 🚀 SPAWNED |
| Complete | ✅ COMPLETED (duration) |
| Cancel | 🛑 CANCELLED |
| Timeout | ⏱️ TIMEOUT |
| Cleanup | 🗑️ CLEANED (session deleted) |
...
Commander will automatically use `spawn_agent` for independent tasks.
