 ...
 * /task - Full Commander mode (mission execution)
 */

// Commander's full system prompt for /task
const COMMANDER_MISSION_PROMPT = `<role>
...
export const COMMANDS: Record<string, { description: string; template: string; argumentHint?: string }> = {
    "task": {
        description: "🚀 FULL COMMANDER MODE - Execute mission autonomously until complete",
