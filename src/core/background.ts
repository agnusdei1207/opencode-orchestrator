...
class BackgroundTaskManager {
    ...
    private loadFromDisk(): void {
        ...
        try {
            ...
            this.debug("system", `Failed to load tasks: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    ...
    private saveToDisk(): void {
        ...
        try {
            ...
            this.debug("system", `Failed to save tasks: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
