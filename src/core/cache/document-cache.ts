 ...
 * 
 * Caches fetched documentation locally for re-reference
 * Reduces repeated API calls and enables offline access
 */
...
const METADATA_FILE = ".cache/docs/_metadata.json";
